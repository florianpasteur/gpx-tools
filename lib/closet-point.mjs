 ...
 * @param allPoints {lat: number, lon: number, distanceFromTheStart: number, segmentDistance: number}[]
 * @returns {{distance: number, point: {lat: number, lon: number, distanceFromTheStart: number, segmentDistance: number}, direction: string}}
 *
 */
